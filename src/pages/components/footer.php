    ...
    <footer class="footer">
        <div class="footer__top">
            <div class="footer__background" style="background-image: url('/build/img/mimi-thian-ZKBzlifgkgw-unsplash.jpg')">
                <div class="container">
                    <div class="footer__form-box rounded-4_5 text-center">
                        ...
                        <div class="footer__form-subtitle fsz-lg">Наш менеджер ответит на интересующие Вас вопросы в течении 10 минут.</div>
                        <form class="footer__form" method="post">
                            ...
                            <div class="footer__form-item fsz-md">
        ...
        <div class="footer__bottom">
            <div class="container">
                <div class="row">
                    <div class="footer__board col-md-12 rounded-5">
