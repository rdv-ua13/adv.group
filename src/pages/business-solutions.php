...
<div class="container">
    <div class="row">
        <div class="col-12 mb-5 mb-md-6 mb-lg-7 mb-xl-8">
            <div class="h2 mb-4 mb-lg-5">Решения <span class="text--red">для бизнеса</span></div>
            <div class="row">
                <div class="col-md-12 framed framed--main framed--multilvl">
                    <div class="row">
...
<div class="container">
    <div class="row">
        ...
        <div class="framed-wrapper col-12 mb-5 mb-md-6 mb-lg-7 mb-xl-8">
            <div class="row">
